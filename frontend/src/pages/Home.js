...
function Home() {
  ...
  },[]);//we want to load only once when component is mounting/loading thats why an empty array as dependency
  ...
  const submitComment = (event, postId)=>{
    event.preventDefault();//avoid the page refresh
                ...
                return(
                    <div className="card home-card" key={post._id}>
                        <h5 style={{ padding: "10px" }}>
                            ...
                            && <i onClick={()=>deletePost(post._id)} className="material-icons" style={{ color:"red", cursor: "pointer", float: "right", fontSize: "35px" }}>delete_forever</i>}
                        </h5>
                        ...
                        <div className="card-content">
                            <i className="material-icons" style={{ color:"red", marginRight: "10px" }}>favorite</i>
                            {
                                ...
                                ? <i onClick={()=>likeUnlike(post._id, '/unlike')} className="material-icons" style={{ color:"grey", cursor: "pointer" }}>thumb_down</i>
