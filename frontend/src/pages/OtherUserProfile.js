...
const follow = ()=>{
    ...
    .then(function (updatedUser) {
       ...
       dispatch({type: "UPDATE", payload:{following: updatedUser.following}})
        ...
        setUserProfile((prevState)=>{
            return{
                ...
                user: {
                    ...prevState.user,
                    //update the followers count by adding the logedin user id into the followers list of other user
       ...
       dispatch({type: "UPDATE", payload:{following: updatedUser.following}})
        ...
        setUserProfile((prevState)=>{
            ...
            return{
                ...
                user: {
                    ...prevState.user,
                    //update the followers count by removing the logedin user id into the followers list of other user
